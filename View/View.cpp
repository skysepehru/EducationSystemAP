...
void View::makeMenus( Menu* root ){
    ...
    auto mathClassReadMembersFromFile = new LeafMenu{"Read Members From File",mathClassMenu};
    auto mathClassCalculateTotalSalary = new LeafMenu{"Calculate Total Salary",mathClassMenu};
    mathClassMenu->setSubMenus(vector<Menu*>{mathClassReadMembersFromFile,mathClassCalculateTotalSalary});
}
